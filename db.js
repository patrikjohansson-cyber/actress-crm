...
module.exports = {
  ...
  getDashboardOpportunities() {
    const jobs    = db.prepare('SELECT id, title, organization, deadline, url, interesting_score, interesting_reason, opportunity_subtype FROM job_listings ORDER BY found_at DESC LIMIT 5').all();
